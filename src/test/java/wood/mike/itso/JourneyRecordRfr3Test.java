...
import wood.mike.itso.journey.*;

import java.time.LocalDateTime;
import java.time.Month;

public class JourneyRecordRfr3Test {

    @Test
    public void testToTransportFormat() {
        JourneyRecordRfr3 jr = new JourneyRecordRfr3(
                getStandardElements(),
                getJourneyCore(),
                getRfr3Extension(),
                getJourneyFooter());
    ...
    private Rfr3Extension getRfr3Extension() {
        return new Rfr3Extension()
                .setServiceOperatorId("132")
                .setServiceNumber("1")
                .setTripOrTrainNumber("0")
                .setReimbursementDataFlags(1)
